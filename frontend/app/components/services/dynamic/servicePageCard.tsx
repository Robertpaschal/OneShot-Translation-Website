...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  <a
    href={`/services/${title
      ...
      .replace(/\(.*?\)/g, '')
      .replace(/-$/, '')}`}
    className={`flex flex-col md:flex-row items-center md:justify-between gap-6 md:gap-10 p-6 md:p-10 bg-[#bad3da] rounded-[45px] border-t border-l border-r border-[#13536c] border-b-4 border-b-[#13536c] w-full ${
