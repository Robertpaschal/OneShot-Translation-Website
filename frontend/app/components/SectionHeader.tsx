...
const SectionHeader: React.FC<SectionHeaderProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row justify-start items-center gap-7 w-full max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 xl:px-16 mb-10 lg:ml-20">
      <div className="flex flex-col px-[10px] py-[8px] bg-[#bad3da] rounded-[7px] flex-col justify-start items-start gap-3 flex">
