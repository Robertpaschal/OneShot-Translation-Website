...
const WorkingProcess = () => {
  ...
  return (
    <div className="relative w-full lg:w-[1440px] h-auto px-4 md:px-10 lg:px-20 max-w-full mx-auto">
      {/* Header Section */}
      <div
        className="flex flex-col md:flex-row justify-start items-center md:items-start gap-7 max-w-full mx-auto"
        style={{ marginTop: '0px', marginBottom: '0px', marginLeft: '40px' }}
      >
